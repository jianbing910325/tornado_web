#!/usr/bin/env python
# -*- coding:utf8 -*-
#from https://github.com/zs1621/tornado-redis-session/blob/master/session.py

__author__ = "zs1213yh@gmail.com"
...
class SessionManager(object):
	...
	try:
		...
		self.redis = redis.StrictRedis(host=store_options['redis_host'], port=store_options['redis_port'], password=store_options['redis_pass'],db=1)
            else:
		self.redis = redis.StrictRedis(host=store_options['redis_host'], port=store_options['redis_port'],db=1)
